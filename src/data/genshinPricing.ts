...
export const pricingData: RegionServiceBlock[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Dragonspine — Explore Chest", price: 60000, group: "Dragonspine" },
  ...
  // ───── INAZUMA ─────
  {
    ...
    items: [
      ...
      { name: "All Electroculus", price: 150000 },
    ],
  },
  {
    region: "Inazuma",
  ...
  // ───── SUMERU DESERT ─────
  {
    ...
    items: [
      ...
      { name: "Gurun Hijau — Ashavan Realm", price: 65000, group: "Explore Gurun Hijau" },
      ...
      { name: "Gurun Pasir — Hypostyle Desert", price: 70000, group: "Explore Gurun Pasir" },
  ...
  },
  {
    ...
    category: "Quest Prasyarat",
    items: [
      { name: "Beryl — Warna Warna Kuno", price: 50000, group: "Beryl" },
      { name: "Beryl — Kitab Kebenaran Samudera & Berkas Misterius", price: 25000, group: "Beryl" },
      ...
      { name: "Liffey — Komedi Yang Belum Selesai", price: 50000, group: "Liffey" },
      { name: "Research Inst. — Kisah Institusi Penelitian Fontaine", price: 50000, group: "Research Inst" },
      { name: "Research Inst. — Menuju Keganjilan", price: 30000, group: "Research Inst" },
      { name: "Research Inst. — Cahaya Pengkhianatan Dasar Laut", price: 25000, group: "Research Inst" },
      ...
      { name: "Morte — Jejak Narcissus (Pencarian Di Lautan Alga / Kebangkitan / Bangkit Dari Mimpi / Perahu Sungai)", price: 50000, group: "Morte" },
    ],
  },
  ...
  },
  {
    ...
    category: "Area Khusus",
    items: [
      { name: "Explore Chest", price: 50000, group: "Frost Moon" },
      { name: "Lunoculus", price: 50000, group: "Frost Moon" },
      { name: "Quest", price: 50000, group: "Frost Moon" },
    ],
  },
