...
export const pricingData: RegionServiceBlock[] = [
  // ───── MONDSTADT ─────
  {
    ...
    category: "Explore",
    items: [
      { name: "Windcry Hill", price: 40000 },
      { name: "Windwail Highland", price: 40000 },
      { name: "Starfell Valley", price: 50000 },
      { name: "Brightcrown Mountains", price: 45000 },
      { name: "Windrest Peak", price: 35000 },
  ...
  },
  {
    ...
    items: [
      { name: "Dragonspine — Quest", price: 40000, group: "Dragonspine" },
      { name: "Dragonspine — Explore Chest", price: 55000, group: "Dragonspine" },
      { name: "Dragonspine — All Crimson Agate", price: 50000, group: "Dragonspine" },
      { name: "Temple Of Space — Quest", price: 50000, group: "Temple Of Space" },
      { name: "Temple Of Space — Explore Chest", price: 60000, group: "Temple Of Space" },
      { name: "Temple Of Space — All Mnemonic Clusters", price: 35000, group: "Temple Of Space" },
    ],
  },
  {
    region: "Mondstadt",
  ...
  // ───── LIYUE ─────
  {
    ...
    category: "Explore",
    items: [
      { name: "Sea Of Clouds", price: 50000 },
      { name: "Lisha", price: 45000 },
      { name: "Qiongji Estuary", price: 50000 },
      { name: "Minlin", price: 75000 },
      { name: "Bishui Plain", price: 65000 },
      { name: "The Chasm", price: 40000 },
      { name: "All Geoculus", price: 65000 },
    ],
  },
  {
    region: "Liyue",
    category: "Area Khusus",
    items: [
      { name: "Chenyu Vale — Quest: Berkah Chenyu Dari Giok Karam", price: 55000, group: "Chenyu Vale" },
      { name: "Chenyu Vale — Explore Chest: Upper Vale", price: 50000, group: "Chenyu Vale" },
      { name: "Chenyu Vale — Explore Chest: Southern Mountain", price: 50000, group: "Chenyu Vale" },
      { name: "Chenyu Vale — Explore Chest: Mt Laixin", price: 25000, group: "Chenyu Vale" },
      { name: "Chenyu Vale — All Spirit Carp", price: 55000, group: "Chenyu Vale" },
      ...
      { name: "The Chasm Underground — Explore Chest", price: 50000, group: "The Chasm: Underground Mines" },
      { name: "The Chasm Underground — All Lumenspar", price: 55000, group: "The Chasm: Underground Mines" },
    ],
  },
  {
    region: "Liyue",
  ...
  // ───── INAZUMA ─────
  {
    ...
    category: "Explore",
    items: [
      { name: "Narukami Island", price: 55000 },
      { name: "Kannazuka", price: 45000 },
      { name: "Yashiori Island", price: 45000 },
      { name: "Watatsumi Island", price: 45000 },
      { name: "Seirai Island", price: 45000 },
      { name: "Tsurumi Island", price: 55000 },
  ...
  },
  {
    ...
    items: [
      { name: "Ritual Pemurnian Sacred Sakura", price: 55000, group: "1. Narukami Island" },
      { name: "Kisah Tatara", price: 30000, group: "2. Kannazuka" },
      { name: "Warisan Orobashi", price: 40000, group: "3. Yashiori Island" },
      { name: "Dasar Pemandian Bulan", price: 25000, group: "4. Watatsumi Island" },
      { name: "Pemburu Badai Seirai", price: 35000, group: "5. Seirai Island" },
      { name: "Perjalanan Menembus Kabut", price: 60000, group: "6. Tsurumi Island" },
    ],
  },
  {
    region: "Inazuma",
  ...
  // ───── ENKANOMIYA (sub Inazuma) ─────
  {
    ...
    items: [
      { name: "Dasar Pemandian Bulan", price: 25000, group: "Quest Buka Area Enkanomiya" },
      { name: "Pintu Masuk Ke Tokoyo", price: 25000, group: "Quest Buka Area Enkanomiya" },
      { name: "Aliran Air Yang Tenang", price: 25000, group: "Quest Buka Area Enkanomiya" },
      { name: "Dari Senja Hingga Fajar Byakuyakoku", price: 40000, group: "Quest Buka Area Enkanomiya" },
      { name: "Rahasia Erobos (Tantangan Yachimatahiko, Yachimatahime, Kunado, Tija Ujian)", price: 25000, group: "Quest Prasyarat Dalam Enkanomiya" },
      { name: "Kolenski Naga Dan Ular (Perlu Tantangan Date, Berkas Tiga Warna, Antigonus)", price: 40000, group: "Quest Prasyarat Dalam Enkanomiya" },
      { name: "Nyanyian Duka Hyperion (Perlu Kumpul 59 Sigil)", price: 25000, group: "Quest Prasyarat Dalam Enkanomiya" },
      { name: "Pemakan Lotus", price: 25000, group: "Quest Prasyarat Dalam Enkanomiya" },
    ],
  },
  {
    region: "Inazuma",
    ...
    items: [
      { name: "Explore Chest + 59 Sigil", price: 90000 },
      { name: "59 Sigil Saja", price: 45000 },
    ],
  },
  ...
  // ───── SUMERU DESERT ─────
  {
    ...
    items: [
      ...
      { name: "Gurun Hijau — Vanarana", price: 25000, group: "Explore Gurun Hijau" },
      { name: "Gurun Hijau — Vissudha Field", price: 40000, group: "Explore Gurun Hijau" },
      { name: "Gurun Hijau — Avidya Forest", price: 45000, group: "Explore Gurun Hijau" },
      { name: "Gurun Hijau — Ashavan Realm", price: 60000, group: "Explore Gurun Hijau" },
      { name: "Gurun Hijau — Ardravi Valley", price: 50000, group: "Explore Gurun Hijau" },
      { name: "Gurun Hijau — Lost Nursery", price: 20000, group: "Explore Gurun Hijau" },
      { name: "Gurun Pasir — Land Of Upper Setekh", price: 40000, group: "Explore Gurun Pasir" },
      { name: "Gurun Pasir — Hypostyle Desert", price: 65000, group: "Explore Gurun Pasir" },
      { name: "Gurun Pasir — Land Of Lower Setekh", price: 55000, group: "Explore Gurun Pasir" },
      { name: "Gurun Pasir — Desert Of Hadramaveth", price: 105000, group: "Explore Gurun Pasir" },
      ...
      { name: "All Dendroculus", price: 215000, group: "Spesial Item" },
      { name: "All Plume of Purifying Light", price: 40000, group: "Spesial Item" },
    ],
  },
  {
    region: "Sumeru Desert",
  ...
  },
  {
    ...
    items: [
      { name: "Aranyaka I — Perjumpaan Di Hutan", price: 30000, group: "Quest Aranyaka" },
      { name: "Aranyaka II — Kebut Bibit Di Dalam Mimpi", price: 85000, group: "Quest Aranyaka" },
      { name: "Aranyaka III — Taman Impian Yang Hilang", price: 60000, group: "Quest Aranyaka" },
      { name: "Aranyaka IV — Pada Akhirnya Hutan Akan Selalu Mengingat", price: 30000, group: "Quest Aranyaka" },
      { name: "Centang Chapter I : Perjumpaan Di Hutan", price: 15000, group: "Quest Aranyaka" },
      { name: "Centang Chapter III : Varuna Gatha", price: 30000, group: "Quest Aranyaka" },
      { name: "Centang Chapter IV : Agnihotra Sutra", price: 35000, group: "Quest Aranyaka" },
  ...
  // ───── FONTAINE ─────
  {
    ...
    category: "Explore",
    items: [
      { name: "Beryl Region", price: 50000 },
      { name: "Belleau Region", price: 35000 },
      { name: "Court of Fontaine Region", price: 55000 },
      { name: "Liffey Region", price: 40000 },
      { name: "Fontaine Research Institute", price: 60000 },
      { name: "Erinnyes Forest", price: 40000 },
      { name: "Morte Region", price: 55000 },
      { name: "All Hydroculus", price: 215000 },
    ],
  },
  {
    region: "Fontaine",
    ...
    items: [
      ...
      { name: "Nostoi Region & Sea Of Bygone Eras — Quest", price: 55000, group: "Area Khusus Quest" },
    ],
  },
  {
    region: "Fontaine",
  ...
  // ───── NATLAN ─────
  {
    ...
    category: "Explore",
    items: [
      { name: "Taquemecan Valley", price: 50000 },
      { name: "Coatepec Mountain", price: 55000 },
      { name: "Toyac Springs", price: 40000 },
      { name: "Basin Of Unnumbered Flames", price: 40000 },
      { name: "Tezcatepetonco Range", price: 40000 },
      { name: "Quahuacan Cliff", price: 35000 },
      { name: "Ochkanatlan", price: 55000 },
      { name: "Atocpan", price: 60000 },
      { name: "Easybreeze Holiday Resort", price: 105000 },
      { name: "All Pyroculus", price: 240000 },
    ],
  },
  {
    region: "Natlan",
    category: "Area Khusus",
    items: [
      { name: "Ancient Sacred Mountain — Explore Chest", price: 60000, group: "Ancient Sacred Mountain Explore Chest" },
  ...
  // ───── NOD KRAI ─────
  {
    ...
    category: "Explore",
    items: [
      { name: "Hiisi Island", price: 60000 },
      { name: "Lempo Isle", price: 85000 },
      { name: "Paha Isle", price: 75000 },
      { name: "Voidsea Outlook", price: 60000 },
      { name: "Wavachaser Plain", price: 75000 },
      { name: "Ashveil Peak", price: 55000 },
      { name: "All Luno Culus (Max Level 8)", price: 165000 },
    ],
  },
  {
    region: "Nod Krai",
